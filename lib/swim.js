...
function Swim(opts) {
    ...
    this.net = new Net({
        udp: {
            port: opts.local.port || parseInt(opts.local.host.split(':')[1]),
    ...
    var self = this;
    this.net.on(Net.EventType.Error,function(err){
...
Swim.prototype.localhost = function localhost() {
    return this.membership && this.membership.localhost() || 
    (this.opts.local.host);
};
